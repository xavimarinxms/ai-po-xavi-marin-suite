/**
 * Minimal inline SVG icon set. Kept dependency-free on purpose — the suite
 * only needs ~20 icons, not a whole icon package. Each icon accepts a
 * className so callers control size and color via Tailwind.
 */

type IconProps = { className?: string };

export function IconComponents({ className }: IconProps) {
  return (
...
export function IconTestPipe({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <path d="M9 2v7.5L4 18a2 2 0 0 0 1.8 3h12.4a2 2 0 0 0 1.8-3l-5-8.5V2" />
...
export function IconChecklist({ className }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
      <polyline points="3.5 5.5 5 7 8 4" />
      <line x1="11" y1="6" x2="21" y2="6" />
      <polyline points="3.5 12.5 5 14 8 11" />
      <line x1="11" y1="13" x2="21" y2="13" />
      <polyline points="3.5 19.5 5 21 8 18" />
...
/** Registry so tools.ts can reference icons by string key without imports. */
